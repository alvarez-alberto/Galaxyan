...
def system_collision_bulletenemy_player(world: esper.World, player_entity: int, explosion_cfg:dict, sizew:int, sizeh:int):
    components_bullet_enemy = world.get_components(CSurface, CTransform, CTagBulletEnemy)
    components_lives = world.get_components(CSurface, CTransform, CTagLives)
    ...
    for bullet_enemy_entity, (c_s, c_t, c_tgb) in components_bullet_enemy:
